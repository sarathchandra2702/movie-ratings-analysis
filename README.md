...
The analysis is based on two real-world datasets:

fandango_scrape.csv – Movie ratings collected from Fandango
...
Loads and merges multiple movie rating datasets

Cleans and preprocesses the data

Performs exploratory data analysis (EDA)

Visualizes rating distributions and differences

Compares how platforms score the same movies
...
How ratings are distributed on each platform

Which platforms tend to rate higher or lower

Differences between critic and audience scores
...
How movie ratings differ between platforms

Which platforms show signs of rating inflation or deflation

How consistent movie scores are across sites

How users and critics evaluate films differently
...
Compare and interpret complex data sources
